...
func (m *MockBookService) GetBooks() (models.Books, error) {
	m.ctrl.T.Helper()
...
func (m *MockBookService) CreateBook(arg0 *models.Book) error {
	m.ctrl.T.Helper()
...
func (m *MockBookService) UpdateBook(arg0 *models.Book) error {
	m.ctrl.T.Helper()
